...
# Gate 1: the SHA that was reviewed must still be the live PR head.
assert_reviewed_head
...
# Gate 4: re-read both mutable pieces of state after checks. A reviewer/comment
# or push may have arrived while the previous commands were running.
assert_reviewed_head
assert_no_unresolved_threads
