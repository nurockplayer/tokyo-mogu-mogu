...
const copies: Record<Locale, ReferenceCopy> = {
  ja: {
    ...
    story: { chapterLabel: 'ストーリー', pointLabel: 'MOGUMOGU ポイント！', nearbyTitle: '近くで味わう', natureTitle: '自然にふれる', generatingRoute: 'あなたの旅程をつくっています…' },
    route: { title: 'モデルルート', halfDay: '半日', fullDay: '1日', mapAlt: 'ルートマップ', saved: '保存済み' },
    spot: { information: 'スポット情報', caution: '訪問前のご注意', guide: 'ガイド・体験', practicalInfo: '基本情報' },
    mogu: { title: 'MOGU', recentTitle: '最近のおすすめ', empty: 'まだおすすめの記録はありません。' },
    favorites: { title: 'お気に入り', empty: '保存したスポットはまだありません。' },
    my: { title: 'マイ', savedRoutes: '保存した旅程', foodProfile: 'フードプロフィール', badges: 'バッジ' },
  },
  en: {
...
export const demoJourneys: JourneyPresentation[] = [
  {
    ...
    copy: {
      ja: { title: '水がつなぐ、江戸から続く辛味', subtitle: '奥多摩のわさび文化をたどる', description: '自然に触れたい、作り手に会いたい、伝統に興味がある人へ。食べて、買って、歩いてたどる旅。', tags: ['自然', '伝統', '半日巡り'], storyTitle: '奥多摩わさびのストーリー', intro: ['山と水に囲まれた奥多摩には、冷たく澄んだ水とともに育まれてきた食文化があります。', 'この旅では、水・作り手・味わいを手がかりに、地域の物語をたどります。'] },
    ...
    chapters: {
      ja: [{ number: '01.', title: 'なぜ、わさびなのか', body: '冷たく澄んだ水が、香りと辛味を育てます。' }, { number: '02.', title: '誰が作っているのか', body: '作り手の手入れと知恵が、畑と味を支えています。' }, { number: '03.', title: '受け継がれてきた技術', body: '土地に合った方法は、人から人へ手渡されてきました。' }, { number: '04.', title: 'いま直面している課題', body: '担い手や自然環境の変化が、継承の課題になっています。' }, { number: '05.', title: 'あなたにできること', body: 'ここで味わい、訪れることが、次の担い手につながります。' }],
  ...
  },
  {
    ...
    copy: {
      ja: { title: '水が育てる、幻の川魚', subtitle: '奥多摩やまめの食文化', description: '川魚と地域の日常が好きな人へ。多摩川の水が育てる味に出会う旅。', tags: ['自然', '川魚', '半日巡り'], storyTitle: '奥多摩やまめのストーリー', intro: ['清らかな水のそばで、地域の食の仕事と味わいが続いています。', '水の恵みを感じながら、川魚の食文化をたどります。'] },
    ...
    chapters: {
      ja: [{ number: '01.', title: '水が育てる味', body: '清らかな水が、川魚の食文化を支えています。' }],
