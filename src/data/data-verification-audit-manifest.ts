...
export const REQUIRED_ROUTE_GUIDANCE_FACTUAL_CLAIMS = [
  ...
  { presentationJourneyId: 'demo-okutama-wasabi', variantId: 'half-day', spotId: 'hikawa-valley', claimId: 'river-safety', fieldLabel: 'Hikawa Valley swimming and high-water safety', timeSensitive: true, canonicalPlaceId: 'hikawa-valley', canonicalFieldId: 'water_safety', issues: ['#329', '#334'] },
...
export const REQUIRED_STORY_SPOT_FACTUAL_CLAIMS = [
  ...
  { presentationJourneyId: 'demo-ome-sake', spotId: 'sawai-ozawa-shuzo', claimId: 'story.spot.sawai-ozawa-shuzo.reservation-requirement', fieldLabel: 'Ozawa Shuzo tour reservation and official-check note', parentFieldId: 'presentation:spot_group:nearby', timeSensitive: true, canonicalSpotDetailId: 'sawai-ozawa-shuzo', canonicalFieldId: 'reservation', presentationField: 'note' },
