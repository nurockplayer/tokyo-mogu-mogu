...
export const REQUIRED_STORY_FACTUAL_CLAIMS = {
  ...
  'demo-ome-sake': [
    ...
    { claimId: 'story.factual.brewery-tour-reservation', fieldLabel: 'Brewery-tour reservation requirement', parentFieldId: 'presentation:story_chapters', timeSensitive: true, canonicalSpotDetailId: 'sawai-ozawa-shuzo', canonicalFieldId: 'reservation', presentationSpotId: 'sawai-ozawa-shuzo', presentationField: 'note' },
