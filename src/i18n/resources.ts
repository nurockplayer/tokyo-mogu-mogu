...
export const strings = {
  ja: {
    ...
    dataYamameDescription: '奥多摩の清流で育つ渓流魚。釣り体験と塩焼きで味わえます。',
    ...
    // Post-profile fork (Figma Talk12 3:1835)
    fpForkTitle: 'では、今回はどんな食旅にしましょう？',
    fpForkRecommend: '自分に合った旅をおすすめしてもらう！',
    fpForkBrowse: '自分で旅を探す',
    // Exploration latest-Figma options (presentation-only; Figma 4:2101 / 8:2436 /
    // 23:3131 / 23:3207 / 23:3262 / 8:2608).
    exExpVisit: '産地を訪ねる',
    exExpVisitSub: '農園や産地を訪ねる',
    exExpLearn: '食文化を学ぶ',
    exExpLearnSub: '食の歴史や文化を知る',
    exAreaTokyo: '東京都',
    exAreaPeriphery: '周辺',
    ...
    exTravel90: '1時間30分以内',
    exTravel2h: '2時間以内',
    exTravelAny: '時間は気にしない',
    exDurationUndecided: 'まだ決めていない',
    exTasteMild: 'やさしい味',
    exTasteSavory: '香ばしいもの',
    exTasteFermented: '発酵の味',
    exTasteNatural: '素材の味を楽しみたい',
    exTasteAny: 'おまかせ',
    exQ5TasteLabel: '1.好きな味は？(複数選択)',
    exQ5ThemeLabel: '2.気になるテーマは？(複数選択)',
    exSubStep: '{n}/{total}',
    exThemeTradition: '伝統',
    exThemeFoodHistory: '飲食歴史',
    exThemeDaily: '地域の日常',
    exThemeCraft: 'ものづくり',
    exThemeNature: '自然',
    exThemeSeason: '季節・旬',
    exThemeFarm: '農業・生産地',
    exThemePeople: '地元の人との交流',
    exThemeAny: 'こだわりがない',
    // Result presentation (Figma 23:3380)
    s3ResultCount: '結果:{n}件',
    s3MatchPercentLow: '91%',
    s3FigmaTagNature: '自然',
    s3FigmaTagTradition: '伝統',
    s3FigmaTagHalfDay: '半日巡り',
    s3SecondaryNote: 'こちらは別の提案例です（プレゼンテーション用・非評価）。',
    // Presentation-only bottom nav + returning home (Figma 3:1952 / 55:4166)
    navProtoExplore: '食旅を見つけ',
    navProtoMogu: 'モグモグる',
    navProtoFav: 'お気に入り',
    navProtoMy: 'マイ',
    homePastTrips: '私の食旅 (過去の旅)',
    homeSeeAll: 'すべて見る',
    homeTripTitle: '旅のタイトル',
    homeTripDesc: '簡単な説明やコンテンツ、簡単な説明やコンテンツ.....',
    // Story presentation (Figma 52:3995)
  ...
  en: {
    ...
    dataYamameDescription:
      'River trout raised in Okutama\'s clear streams. Enjoy a catch-and-taste experience or salt-grilled trout.',
    ...
    exExpVisit: 'Visit the origin',
    exExpVisitSub: 'Visit farms and production areas',
    exExpLearn: 'Learn the food culture',
    exExpLearnSub: 'Know the history and culture of the food',
    exAreaTokyo: 'Tokyo',
    exAreaPeriphery: 'Surrounding area',
    exAreaSearchLabel: 'Search an area',
    exAreaSearchPlaceholder: 'Enter an area, place, or station',
    exTravel90: 'Within 90 minutes',
    exTravel2h: 'Within 2 hours',
    exTravelAny: "I don't mind the time",
    exDurationUndecided: "Haven't decided yet",
    exTasteMild: 'Mild taste',
    exTasteSavory: 'Savory / roasted',
    exTasteFermented: 'Fermented taste',
    exTasteNatural: 'I want to taste the ingredients',
    exTasteAny: 'Surprise me',
    exQ5TasteLabel: '1. What tastes do you like? (multi-select)',
    exQ5ThemeLabel: '2. What themes interest you? (multi-select)',
    exSubStep: '{n}/{total}',
    exThemeTradition: 'Tradition',
    exThemeFoodHistory: 'Food history',
    exThemeDaily: 'Local daily life',
    exThemeCraft: 'Craft',
    exThemeNature: 'Nature',
    exThemeSeason: 'Season & freshness',
    exThemeFarm: 'Farming & origin',
    exThemePeople: 'Meeting local people',
    exThemeAny: 'No particular preference',
    s3ResultCount: 'Results: {n}',
    s3MatchPercentLow: '91%',
    s3FigmaTagNature: 'Nature',
    s3FigmaTagTradition: 'Tradition',
    s3FigmaTagHalfDay: 'Half-day trip',
    s3SecondaryNote: 'This is an alternative suggestion (presentation only, not scored).',
    navProtoExplore: 'Find a journey',
    navProtoMogu: 'Mogu Mogu',
    navProtoFav: 'Favorites',
    navProtoMy: 'My',
    homePastTrips: 'My food journeys (past trips)',
    homeSeeAll: 'See all',
    homeTripTitle: 'Journey title',
    homeTripDesc: 'A short description of the journey, a short description of the journey.....',
  ...
  'zh-TW': {
    ...
    dataYamameDescription: '在奧多摩清澈溪流中孕育的溪流魚。可體驗釣魚，並品嘗鹽烤山女魚。',
    ...
    exExpVisit: '造訪產地',
    exExpVisitSub: '拜訪農園與產地',
    exExpLearn: '學習飲食文化',
    exExpLearnSub: '認識飲食的歷史與文化',
    exAreaTokyo: '東京都',
    exAreaPeriphery: '周邊',
    ...
    exTravel2h: '2小時以內',
    exTravelAny: '時間不限',
    exDurationUndecided: '還沒決定',
    exTasteMild: '溫和的味道',
    exTasteSavory: '香氣十足的食物',
    exTasteFermented: '發酵的味道',
    exTasteNatural: '想品嘗食材原味',
    exTasteAny: '交給你了',
    exQ5TasteLabel: '1.喜歡什麼味道？(可複選)',
    exQ5ThemeLabel: '2.對什麼主題感興趣？(可複選)',
    exSubStep: '{n}/{total}',
    exThemeTradition: '傳統',
    exThemeFoodHistory: '飲食歷史',
    exThemeDaily: '在地日常',
    exThemeCraft: '工藝手作',
    exThemeNature: '自然',
    exThemeSeason: '季節・旬味',
    exThemeFarm: '農業・產地',
    exThemePeople: '與當地人交流',
    exThemeAny: '沒有特別偏好',
    s3ResultCount: '結果：{n} 件',
    s3MatchPercentLow: '91%',
    s3FigmaTagNature: '自然',
    s3FigmaTagTradition: '傳統',
    s3FigmaTagHalfDay: '半日巡禮',
    s3SecondaryNote: '這是另一個提案範例（僅供展示，未評分）。',
    navProtoExplore: '尋找旅程',
    navProtoMogu: 'もぐもぐる',
    navProtoFav: '收藏',
    navProtoMy: '我的',
    homePastTrips: '我的飲食之旅（過往旅程）',
    homeSeeAll: '查看全部',
    homeTripTitle: '旅程標題',
    homeTripDesc: '旅程的簡單說明、旅程的簡單說明.....',
