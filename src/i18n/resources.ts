...
export const strings = {
  ja: {
    ...
    s5SupportTitle: 'この旅が、地域への支援になる',
    s5SupportLead:
      '訪れて、保存して、実際に巡ること。そのひとつひとつが、奥多摩の作り手と文化をつなぐ力になります。',
    s5SupportVisit: '訪れる',
    s5SupportVisitDesc: '現地の風景や作り手を知ることは、地域の営みを守る力になります。',
    s5SupportSave: '保存する',
    s5SupportSaveDesc: 'この旅程を保存しておけば、今日の関心を実際の訪問につなげられます。',
    s5SupportGo: '巡る',
    s5SupportGoDesc:
      '行程を実際に巡ることで、食べる・買う・体験することが文化の継承につながります。',
    s5BackToStory: '物語に戻る',
    ...
    s6ImpactRestaurant: '店で味わうことは、作り手と地域の味を次の世代へつなぎます。',
    s6ImpactWorkshop: '体験に参加することは、受け継がれてきた技術と知恵を支えます。',
    s6ImpactShop: '買い物は、地域の生産者の暮らしと文化の継承を直接支えます。',
    s6ImpactFarm: '産地を訪れることは、地域の風景と営みを守る力になります。',
  ...
  en: {
    ...
    /* S5 route-local support meaning (#80) */
    s5SupportKicker: 'SUPPORT',
    s5SupportTitle: 'How this journey supports the region',
    s5SupportLead:
      'Visit it. Save it. Walk the route. Each of these connects you to Okutama\'s makers and keeps their craft alive.',
    s5SupportVisit: 'Visit',
    s5SupportVisitDesc:
      'Seeing the place and its makers in person keeps the region\'s way of life going.',
    s5SupportSave: 'Save',
    s5SupportSaveDesc:
      "Saving this itinerary turns today's interest into a real visit.",
    s5SupportGo: 'Go',
    s5SupportGoDesc:
      'Tasting, buying, and experiencing along the route is how the culture lives on.',
    ...
    s6ImpactRestaurant: 'Tasting on site passes the region\'s flavors and craft on to the next generation.',
    s6ImpactWorkshop: 'Joining an experience supports the skills and wisdom passed down here.',
    s6ImpactShop: 'Buying directly supports local producers\' livelihoods and cultural succession.',
    s6ImpactFarm: 'Visiting the source helps protect the region\'s landscape and way of life.',
  ...
  'zh-TW': {
    ...
    /* S5 路線在地支持意涵 (#80) */
    s5SupportKicker: 'SUPPORT',
    s5SupportTitle: '這趟旅程，就是對地區的支持',
    s5SupportLead:
      '到訪、儲存、實際走訪。每一個行動，都是連結奧多摩的生產者與文化、並讓它延續下去的力量。',
    s5SupportVisit: '到訪',
    s5SupportVisitDesc: '親自認識當地的風景與生產者，是守護這片土地生命力的力量。',
    s5SupportSave: '儲存',
    s5SupportSaveDesc: '儲存這趟行程，就能把今天的關注化為實際的到訪。',
    s5SupportGo: '走訪',
    s5SupportGoDesc: '實際走訪行程，讓品嚐、購買、體驗都成為文化傳承的一部分。',
    s5BackToStory: '返回故事',
    /* S6 spot detail (Issue #45) */
    s6CategoryShop: '店家',
    ...
    s6ImpactRestaurant: '在店裡品嚐，是把地區的風味與技術傳遞給下一代。',
    s6ImpactWorkshop: '參加體驗，是支持代代相傳的技術與智慧。',
    s6ImpactShop: '購物直接支持在地生產者的生活與文化傳承。',
    s6ImpactFarm: '親自到訪產地，是守護地區風景與生活樣貌的力量。',
