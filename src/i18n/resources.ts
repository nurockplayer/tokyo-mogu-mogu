...
export const strings = {
  ja: {
    ...
    // Figma dietary category chips — proposed-input preview (Issue #226),
    // never evaluated or persisted by this prototype
    fpDietaryChipsTitle: 'お食事についてお聞かせください（プロトタイプ表示）',
    fpDietaryChipsBody:
      '選択いただいた内容は、このプロトタイプでは評価・保存されません。実際の対応可否は現地・店舗に直接ご確認ください。',
    ...
    // Figma Food Profile dietary category chips (Issue #226 — proposed UI,
    // no compatibility/safety claim)
    fpDAllergyEgg: '🥚 卵',
    fpDAllergyDairy: '🥛 乳製品',
    fpDAllergyWheat: '🌾 小麦',
    fpDAllergyShellfish: '🦐 甲殻類',
    fpDAllergyNut: '🥜 ナッツ',
    fpDAllergyFish: '🐟 魚',
    fpDAllergyNone: 'アレルギーはありません',
    fpDDietVeg: '🥗 ベジタリアン',
    fpDDietVegan: '🌱 ヴィーガン',
    fpDDietPesca: '🐟 ペスカタリアン',
    fpDReligionPork: '🐖 豚肉',
    fpDReligionBeef: '🐄 牛肉',
    fpDReligionHalal: '☪️ ハラール対応が必要',
    fpDReligionAlcohol: '🍷 アルコール',
    fpDDislikeRaw: '🐟 生もの',
    fpDDislikeSpicy: '🌶 辛いもの',
    fpDDislikeFermented: '🫘 発酵食品',
    fpDDislikeBitter: '😖 苦いもの',
    fpDDislikeShellfish: '🐚 貝類',
    fpDNone: '特になし',
    fpDOther: '✏️ その他',
  ...
  en: {
    ...
    // Figma dietary category chips — proposed-input preview (Issue #226)
    fpDietaryChipsTitle: 'Tell us about your meals (prototype preview)',
    fpDietaryChipsBody:
      'Your selections are a preview only — this prototype does not evaluate or save them. Please confirm actual availability directly with the venue or shop.',
    ...
    // no compatibility/safety claim)
    fpDAllergyEgg: '🥚 Egg',
    fpDAllergyDairy: '🥛 Dairy',
    fpDAllergyWheat: '🌾 Wheat',
    fpDAllergyShellfish: '🦐 Shellfish',
    fpDAllergyNut: '🥜 Nuts',
    fpDAllergyFish: '🐟 Fish',
    fpDAllergyNone: 'No allergies',
    fpDDietVeg: '🥗 Vegetarian',
    fpDDietVegan: '🌱 Vegan',
    fpDDietPesca: '🐟 Pescatarian',
    fpDReligionPork: '🐖 Pork',
    fpDReligionBeef: '🐄 Beef',
    fpDReligionHalal: '☪️ Halal needed',
    fpDReligionAlcohol: '🍷 Alcohol',
    fpDDislikeRaw: '🐟 Raw food',
    fpDDislikeSpicy: '🌶 Spicy',
    fpDDislikeFermented: '🫘 Fermented food',
    fpDDislikeBitter: '😖 Bitter',
    fpDDislikeShellfish: '🐚 Shellfish',
    fpDNone: 'None',
    fpDOther: '✏️ Other',
    // Exploration conditions (Issue #78, reframe of S2; Issue #217 intro)
  ...
  'zh-TW': {
    ...
    fpDietaryAckCta: '了解',
    // Figma dietary category chips — proposed-input preview (Issue #226)
    fpDietaryChipsTitle: '請告訴我們你的飲食習慣（原型預覽）',
    fpDietaryChipsBody: '你選擇的內容僅供預覽——此原型不會評估或儲存。實際是否適用請直接向當地店家確認。',
    ...
    fpDReligionPork: '🐖 豬肉',
    fpDReligionBeef: '🐄 牛肉',
    fpDReligionHalal: '☪️ 需清真認證',
    fpDReligionAlcohol: '🍷 酒精',
    fpDDislikeRaw: '🐟 生食',
    fpDDislikeSpicy: '🌶 辣味',
    fpDDislikeFermented: '🫘 發酵食品',
    fpDDislikeBitter: '😖 苦味',
    fpDDislikeShellfish: '🐚 貝類',
    fpDNone: '沒有',
    fpDOther: '✏️ 其他',
