...
describe('reference journey query classification', () => {
  ...
  it.each([
    ...
    ['empty then current candidate values', '?candidateId=&candidateId=demo-okutama-wasabi&routeId=okutama-wasabi-journey', 'invalid'],
    ['current then empty candidate values', '?candidateId=demo-okutama-wasabi&candidateId=&routeId=okutama-wasabi-journey', 'reference'],
    ['divergent unknown candidate values', '?candidateId=unknown-candidate&candidateId=other-unknown-candidate', 'invalid'],
    ...
    ['divergent explicit stale route values', '?routeId=stale-route&routeId=other-stale-route', 'invalid'],
    ['divergent unknown route values', '?routeId=unknown-route&routeId=other-unknown-route', 'invalid'],
    ...
    ['divergent legacy candidates led by the coherent candidate', '?candidateId=demo-ome-sake&candidateId=demo-tokyo-hachioji-ginger&routeId=ome-sawai-sake-journey', 'legacy'],
    ['divergent legacy candidates led by the contradictory candidate', '?candidateId=demo-tokyo-hachioji-ginger&candidateId=demo-ome-sake&routeId=ome-sawai-sake-journey', 'invalid'],
    ['divergent legacy route values', '?routeId=ome-sawai-sake-journey&routeId=hachioji-ginger-journey', 'legacy'],
    ['stale route followed by a legacy route', '?routeId=stale-route&routeId=ome-sawai-sake-journey', 'invalid'],
    ['legacy route followed by a stale route', '?routeId=ome-sawai-sake-journey&routeId=stale-route', 'legacy'],
