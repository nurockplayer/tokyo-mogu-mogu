...
1. **Top page** — the concept is readable in one glance: tagline + "next discovery" suggestions. (5 s)
...
8. **Next discovery** — the home page suggests the next collectible (e.g. 奥多摩やまめ); tap through to its detail. (5 s)
